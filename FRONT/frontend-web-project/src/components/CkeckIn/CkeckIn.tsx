...
const CheckIn: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="form-box">
            ...
            <p>Ingrese el código para iniciar el check-in</p>
            <input
                type="text"
                value={code}
                ...
                required
            />
            <small>Ejemplo: todo código que empiece en "E" es válido</small>
            <button className="btn" type="submit">VERIFICAR CÓDIGO</button>
        </form>
    );
};
